...
Use the dad/mentor template in `templates/dad-report.md` and detailed guidance in `references/dad-report-template.md`.
...
Use `templates/personal-report.md` and `references/personal-report-template.md`.
