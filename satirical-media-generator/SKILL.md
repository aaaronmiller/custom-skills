...
*   For visual media (image generation prompts, comic panel descriptions): Use `read_file` to read `{skill_root}/references/visual_format.md`
*   For written media (articles, headlines, fake news): Use `read_file` to read `{skill_root}/references/written_format.md`
*   For spoken media (Daily show scripts, TTS audio prompts, monologues): Use `read_file` to read `{skill_root}/references/spoken_format.md`
## 📎 Resources

📎 `~/code/agents/skills/satirical-media-generator/marketplace.json`
📎 `~/code/agents/skills/satirical-media-generator/references/spoken_format.md`
📎 `~/code/agents/skills/satirical-media-generator/references/visual_format.md`
📎 `~/code/agents/skills/satirical-media-generator/references/written_format.md`
