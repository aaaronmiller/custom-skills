---
name: mcp-conversion
description: 'Convert existing MCP servers into CLI tools, standalone scripts, or
  Claude Skills.
  ...
  '
license: Apache-2.0
compatibility: Requires Python 3.10+ for scripts. Works in Claude Code, Claude.ai,
  and API.
metadata:
  author: ice-ninja
  version: '2.0'
