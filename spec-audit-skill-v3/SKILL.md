...
> See resource: `references/built-vs-designed-guide.md` for detailed worked examples.
...
### `references/built-vs-designed-guide.md`
...
**Location:** `[skill-root]/references/built-vs-designed-guide.md`
