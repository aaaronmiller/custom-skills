...
**Target Roles:** SDE - OpenSearch Vector Search • Amazon
...
**Tailored for:** SDE - OpenSearch Vector Search at Amazon. Build high-performance vector search systems at billion-vector scale. Implement HNSW, cluster-based ANN, GPU-accelerated indexing. Contribute to OpenS
...
**Applying for:** SDE - OpenSearch Vector Search at Amazon
