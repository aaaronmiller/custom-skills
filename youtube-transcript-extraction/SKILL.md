...
description: Extract YouTube video transcripts and transform them into high-fidelity,
  Obsidian-ready knowledge artifacts with structured information groups (recipes,
  prompts, lists, processes, etc). Use when processing video content, extracting instructional
  workflows, or building agentic reference materials from video sources. Supports
