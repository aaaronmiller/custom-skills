...
description: ALWAYS invoke when the user asks to generate, edit, or upscale images using Gemini CLI, Antigravity CLI, Nano Banana, or gemini-3.1-flash.
version: 1.1.0
author: Antigravity Agent
license: MIT
prerequisites:
  commands: [gemini, jq]
  files: [/home/cheta/.gemini/oauth_creds.json, /home/cheta/.gemini/settings.json]
metadata:
  tags: [image-generation, gemini, nano-banana, headless, automation]
inputs:
  - name: prompt
