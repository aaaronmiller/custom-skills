...
description: 'Create visually stunning CLI and TUI applications. Use when: building
  command-line tools that POP visually, designing terminal user interfaces, adding
  icons/colors to CLI output, creating tables/borders in terminal, or making tools
  that don''t look like a rainbow vomited on screen.'
inputs:
...
- `references/color-scheme.yaml` - Semantic color mapping template
- `references/nerd-fonts-guide.md` - Icon reference with codes  
- `references/box-characters.md` - Border character reference
- `references/ansi-codes.md` - Complete ANSI code reference
- `references/cli-design-guides.md` - External design guides
...
📎 `~/code/agents/skills/cli-tui-styling/references/ansi-codes.md`
📎 `~/code/agents/skills/cli-tui-styling/references/box-characters.md`
📎 `~/code/agents/skills/cli-tui-styling/references/cli-design-guides.md`
📎 `~/code/agents/skills/cli-tui-styling/references/color-scheme.yaml`
📎 `~/code/agents/skills/cli-tui-styling/references/nerd-fonts-guide.md`
