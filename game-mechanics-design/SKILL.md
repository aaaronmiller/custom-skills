...
description: "Game Mechanics Design. Use when: designing fun, balanced, interesting game mechanics across game types - card games, RPGs, video games, sports."
description: Expert knowledge for designing fun, balanced, interesting, and interactive game mechanics across all game types—synthesizing Magic The Gathering design, D&D, RPG, video game, and sports design principles
category: skill
tags: [game-design, mechanics, balance, engagement, progression, fun-factor, TTRPGs, card-games, video-games, esports]
dependencies: []
version: 1.0.0
inputs:
  - name: game_concept
