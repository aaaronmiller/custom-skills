...
description: Multi-agent council with 8 agents x 3 rounds for complex problem solving,
  decision making, and quality refinement with structured deliberation.
license: MIT
metadata:
  author: ice-ninja
  version: '1.0'
